...
updated: '2026-09-04T00:33:07.651172426Z'
closed: '2026-09-03T21:26:17.929614871Z'
parent: aix-01m1kydv7r76
tags:
- ready-for-agent
acceptance:
- title: Full build on Linux yields the five binaries, `SHA256SUMS`, and the legacy trio
  done: true
- title: Host-only build yields one binary that answers `--version --json` with the version from the CLI namespace
  done: true
- title: babashka version pinned in exactly one place in the script
  done: true
- title: Release-creation script's file checks cover the new assets and the legacy trio
  done: true
