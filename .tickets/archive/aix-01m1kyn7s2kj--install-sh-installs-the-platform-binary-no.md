...
updated: '2026-09-03T21:26:18.034637143Z'
...
- [x] No reference to babashka remains in the script
- [x] Asset selection covers linux/macos × amd64/aarch64, including the Rosetta case
- [x] Checksum mismatch removes the download and exits non-zero
- [x] Unsupported platform exits with the supported list
- [x] Verified against a locally served `SHA256SUMS` and binary, or against the 4.1.0 release once published
