...
updated: '2026-09-04T00:33:07.213145683Z'
...
- aix-01m1kyn7zqy6
acceptance:
- title: README has no babashka prerequisite anywhere
  done: true
- title: CHANGELOG states the bridging window and the 4.2.0 drop
  done: true
- title: Version is 4.1.0 in the CLI namespace
  done: true
- title: '`docs/ARCHITECTURE.md` or wherever the platform promise lives mentions the five binaries'
  done: true
---
